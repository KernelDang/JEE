<%-- 
    Document   : login
    Created on : Jun 2, 2017, 1:48:33 PM
    Author     : Kernel Dang
--%>
            ...
            <div id="page">
                ...
                <div class="container">
                    <div style="padding: 100px 0px 200px 0px;">
                        <form style="width: 30%;margin: auto" action="login" method="post">
                            <div class="form-group">
                                <s:actionerror theme="bootstrap"/>
                            </div>
                            <div class="form-group">
                                <input type="text" class="form-control" required name="account.username" placeholder="Tên đăng nhập">
                                <s:fielderror fieldName="account.username"></s:fielderror>
                            </div>
                            <div class="form-group">
                                <input type="password" class="form-control" required name="account.password" placeholder="Mật khẩu">
                            <s:fielderror fieldName="account.password"></s:fielderror>
                            </div>
                            <div class="form-group">
