<%-- 
    Document   : blog
    Created on : May 16, 2017, 1:56:48 PM
    Author     : Kernel Dang
--%>
...
<html dir="ltr" class="ltr" lang="en">
    ...
    <body class="main-menu-fixed pavblog-blogs page-pavblog-blogs layout-fullwidth">
                                ...
                                <div class="pav-filter-blogs">
                                    <div class="pav-blogs">
                                        <div class="leading-blogs clearfix">
                                            <div class="pavcol1">
                                                <div class="blog-item box">
                                                    <h2 class="blog-title box-heading ">  <a href="blog_detail.jsp" title="Thời trang thể thao">Thời trang thể thao</a></h2>
                                                    <div class="box-content">
                                                        <div class="blog-meta">
                                                            <ul>
                                                                <li class="created">
                                                        ...
                                                        <div class="blog-body">
                                                            ...
                                                            <div class="blog-readmore"><a href="blog_detail.jsp" class="button btn btn-default">Xem thêm</a></div>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="secondary clearfix">
                                            ...
                                            <div class="pavcol1">
                                                <div class="blog-item box">
                                                    <h2 class="blog-title box-heading ">  <a href="blog_detail.jsp" title="Đại sứ thể thao nước Mỹ">Đại sứ thể thao nước Mỹ</a></h2>
                                                    <div class="box-content">
                                                        <div class="blog-meta">
                                                            <ul>
                                                                <li class="created">
                                            ...
                                            <div class="pavcol1">
                                                <div class="blog-item box">
                                                    <h2 class="blog-title box-heading ">  <a href="blog_detail.jsp" title="Nhãn hàng nước hoa ưa chuộng thể thao?">Nhãn hàng nước hoa ưa chuộng thể thao?</a></h2>
